...
sprites[118] = new Sprite(118, 0, 0, 0.75, 0.75, 0.75, "cold_tree1", true, "Cold Tree", false)
sprites[119] = new Sprite(119, 0, 0, 0.9, 0.75, 0.75, "cold_tree2", true, "Cold Tree", false)
sprites[120] = new Sprite(120, 0, 0, 0.5, 0.5, 0.5, "cold_tree3", true, "Cold Tree", false)
sprites[121] = new Sprite(121, 0, 0, 0.75, 0.75, 0.75, "snowy_cold_tree1", true, "Snowy Cold Tree", false)
sprites[122] = new Sprite(122, 0, 0, 0.9, 0.75, 0.75, "snowy_cold_tree2", true, "Snowy Cold Tree", false)
sprites[123] = new Sprite(123, 0, 0, 0.5, 0.5, 0.5, "snowy_cold_tree3", true, "Snowy Cold Tree", false)
sprites[124] = new Sprite(124, 0, 1, 0.5, 0.5, 0.5, "cold_rock1", true, "Cold Rock", false)
sprites[125] = new Sprite(125, 0, 1, 0.5, 0.5, 0.5, "cold_rock2", true, "Cold Rock", false)
sprites[126] = new Sprite(126, 0, 0.5, 0.5, 0.5, 0.5, "cold_rock3", true, "Big Cold Rock", false)
sprites[127] = new Sprite(127, 0, 4, 3, 3, 2, "cold_leaves1", false, "Cold Leaves", true)
sprites[128] = new Sprite(128, 0, 4, 3, 3, 2, "cold_leaves2", false, "Cold Leaves", true)
sprites[129] = new Sprite(129, 0, 4, 3, 3, 2, "dead_leaves1", false, "Dead Leaves", true)
sprites[130] = new Sprite(130, 0, 4, 3, 3, 2, "dead_leaves2", false, "Dead Leaves", true)
